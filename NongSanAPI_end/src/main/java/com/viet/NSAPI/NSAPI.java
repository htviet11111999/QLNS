...
public class NSAPI {
	...
	@ResponseBody
	public boolean deleteCTN(@PathVariable("maNS") int maNS, @PathVariable("maN") int maN){
		CTNHAP c = new CTNHAP();
		c.setMaNS(maNS);
		c.setMaN(maN);
	...
	@ResponseBody
	public boolean deleteCTX(@PathVariable("maNS") int maNS, @PathVariable("maX") int maX){
		CTXUAT c = new CTXUAT();
		c.setMaNS(maNS);
		c.setMaX(maX);
